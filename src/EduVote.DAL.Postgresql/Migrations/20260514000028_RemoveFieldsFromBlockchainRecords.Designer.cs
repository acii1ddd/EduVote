...
namespace EduVote.DAL.Postgresql.Migrations
{
    ...
    [Migration("20260514000028_RemoveFieldsFromBlockchainRecords")]
    partial class RemoveFieldsFromBlockchainRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.BlockchainRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.Roles.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.VotingResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.BlockchainRecord", b =>
                {
                    b.HasOne("EduVote.DAL.Postgresql.Models.VotingResult", "VotingResult")
                        .WithMany()
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.User", b =>
                {
                    b.HasOne("EduVote.DAL.Postgresql.Models.Roles.Role", "UserRole")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.Voting", b =>
                {
                    b.HasOne("EduVote.DAL.Postgresql.Models.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("EduVote.DAL.Postgresql.Models.VotingResult", b =>
                {
                    b.HasOne("EduVote.DAL.Postgresql.Models.Voting", "Voting")
                        .WithOne("VotingResult")
                        .HasForeignKey("EduVote.DAL.Postgresql.Models.VotingResult", "VotingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
